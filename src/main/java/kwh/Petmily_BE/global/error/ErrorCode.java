...
public enum ErrorCode {
    ...
    PASSWORD_CONFIRM_MISMATCH(HttpStatus.BAD_REQUEST, "PW003", "비밀번호가 일치하지 않습니다."),

    // Email
    EMAIL_VERIFICATION_REQUIRED(HttpStatus.BAD_REQUEST, "EM001", "이메일 인증이 필요합니다."),
    EMAIL_VERIFICATION_FAILED(HttpStatus.BAD_REQUEST, "EM002", "인증번호가 올바르지 않거나 만료되었습니다."),
    ...
    PET_REQUIRED_FOR_CARE(HttpStatus.BAD_REQUEST, "PT002", "돌봄 요청은 반려동물이 필요합니다."),
    ...
    INVALID_REFRESH_TOKEN(HttpStatus.BAD_REQUEST, "TK002", "유효하지 않은 토큰입니다."),

    // Auth
    LOGIN_FAILED(HttpStatus.UNAUTHORIZED, "AUTH001", "로그인에 실패했습니다."),

    // OAuth
    OAUTH_FAILED(HttpStatus.BAD_REQUEST, "AUTH_OAUTH_001", "카카오 OAuth 인증에 실패했습니다."),
